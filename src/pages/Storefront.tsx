...
const sponsors = [
  { id: "google", name: "Google Cloud", clickable: false, logo: "/logos/google.svg", price: 100 },
  { id: "elevenlabs", name: "ElevenLabs", clickable: true, logo: "/logos/elevenlabs.svg", price: 30 },
  { id: "morph", name: "Morph", clickable: true, logo: "/logos/morph.svg", price: 50 },
  { id: "toolhouse", name: "Toolhouse.ai", clickable: false, logo: "/logos/toolhouse.svg", price: 40 },
  { id: "ministry", name: "Ministry of Programming", clickable: false, logo: "/logos/ministry.svg", price: 25 },
  { id: "vapi", name: "VAPI", clickable: false, logo: "/logos/vapi.svg", price: 20 },
  { id: "a1base", name: "A1Base", clickable: false, logo: "/logos/a1base.svg", price: 60 },
];
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {sponsors.map((s) => {
            ...
            const card = (
              <div key={s.id} className="relative rounded-2xl p-6 bg-white/80 border border-gray-100 shadow-xl flex flex-col items-center gap-4 hover:-translate-y-2 hover:shadow-2xl transform transition duration-250">
            ...
            if (s.clickable && s.id === "elevenlabs") {
              return (
                <Dialog key={s.id} open={openDialogId === s.id} onOpenChange={(v) => setOpenDialogId(v ? s.id : null)}>
